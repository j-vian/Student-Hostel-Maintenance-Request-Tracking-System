...
/**
 * Staff manage assigned requests — search, filter, and update status.
 */
public class ManageRequestPage extends javax.swing.JFrame {
    ...
    private void customizeForm() {
        ...
        UIHelper.configureStaffShell(this,
                ...
                UIHelper.StaffNavPage.MANAGE_REQUESTS);
        wireNavigation();
        ...
        UIHelper.applyStaffManageRequestTableRenderers(tblRequests, () -> statusEditMode);
    ...
    private void refreshPaginationFooter() {
        UIHelper.updateStaffPaginationFooter(lblPagination, btnPagePrevious, btnPageNext, requestTableModel);
    }
    ...
    private void enterStatusEditMode() {
        ...
        tblRequests.getColumnModel().getColumn(UIHelper.STAFF_MANAGE_COL_STATUS).setCellEditor(statusCellEditor);
    ...
    private void wireNavigation() {
        ...
        btnNavManageRequests.addActionListener(e -> { /* current page */ });
    ...
    private void initComponents() {
        ...
        tblRequests.setModel(new javax.swing.table.DefaultTableModel(
            new Object [][] {},
            new String [] { "Request ID", "Request Type", "Date Raised", "Status" }
        ) {
    ...
    public static void main(String[] args) {
        ...
        java.awt.EventQueue.invokeLater(() -> new ManageRequestPage());
    }
