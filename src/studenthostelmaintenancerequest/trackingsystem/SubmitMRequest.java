...
public class SubmitMRequest extends javax.swing.JFrame {
    ...
    /**
     * Creates new form SubmitMRequest
     */
    ...
    private void initComponents() {
        ...
        jComboBox1.setModel(new javax.swing.DefaultComboBoxModel<>(new String[] {
            "Select the type of issue", "Electrical", "Plumbing", "Furniture", "Air Conditioning", "Others"
        }));
    ...
    private void jButton6ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jButton6ActionPerformed
        // TODO add your handling code here:
      jTextField1.setText("");                    // clear Date
    jTextField2.setText("");                    // clear Room Number
    jComboBox1.setSelectedIndex(0);             // reset Request Type
    jTextArea1.setText("");                     // clear Issue Description
    jComboBox2.setSelectedIndex(0);             // reset Priority Level
    ...
    if (jComboBox1.getSelectedIndex() == 0) {
        JOptionPane.showMessageDialog(null, "Please select a Request Type.");
        return;
    }
    if (jTextArea1.getText().trim().isEmpty()) {
        JOptionPane.showMessageDialog(null, "Please enter an Issue Description.");
        return;
    }
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(SubmitMRequest.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
